...
class DataEntryForm(ttk.Frame):
    ...
    def createPage(self):
        ...
        ttk.Entry(self.root, text=self.patient_name, textvariable=self.patient_name).grid(row=1, column=1, columnspan=2,pady=10, sticky=W + E)
        ttk.Entry(self.root, text=self.patient_tel, textvariable=self.patient_tel).grid(row=2, column=1, columnspan=2,pady=10, sticky=W + E)
        ttk.Entry(self.root, text=self.patient_birth, textvariable=self.patient_birth).grid(row=3, column=1,columnspan=2, pady=10,sticky=W + E)
        ttk.Entry(self.root, text=self.patient_place, textvariable=self.patient_place).grid(row=4, column=1,columnspan=2, pady=10,sticky=W + E)
        ttk.Radiobutton(self.root, text="否", value=0, variable=self.is_enter).grid(row=5, column=1, padx=5, pady=10, sticky=W)
        ttk.Radiobutton(self.root, text="是", value=1, variable=self.is_enter).grid(row=5, column=2, padx=5, pady=10, sticky=W)
        ttk.Entry(self.root, text=self.diagnosis, textvariable=self.diagnosis).grid(row=6, column=1, pady=10,sticky=W + E)
        ttk.Entry(self.root, text=self.level, textvariable=self.level).grid(row=7, column=1, pady=10, sticky=W + E)
        ttk.Entry(self.root, text=self.admission_time, textvariable=self.admission_time).grid(row=1, column=4, pady=10,sticky=W + E)
        ttk.Entry(self.root, text=self.confirmed_time, textvariable=self.confirmed_time).grid(row=2, column=4, pady=10,sticky=W + E)
        ttk.Radiobutton(self.root, text="否", value=0, variable=self.is_recovery).grid(row=3, column=4, padx=5, pady=10, sticky=W)
        ttk.Radiobutton(self.root, text="是", value=1, variable=self.is_recovery).grid(row=3, column=5, padx=5, pady=10, sticky=W)
        ttk.Entry(self.root, text=self.hospital_id, textvariable=self.hospital_id).grid(row=4, column=4, pady=10,sticky=W + E)
        ttk.Entry(self.root, text=self.worker_id, textvariable=self.worker_id).grid(row=5, column=4, pady=10,sticky=W + E)
        ttk.Entry(self.root, text=self.medical_supplies_id, textvariable=self.medical_supplies_id).grid(row=6, column=4,pady=10,sticky=W + E)
        ttk.Button(self.root, text='提交', command=self.datacommit, width=10, bootstyle="Primary").grid(row=8, column=1,pady=10)
        ttk.Button(self.root, text='关闭', command=self.closePage, width=10, bootstyle="Danger").grid(row=8, column=3,pady=10)
